$(document).ready(function(){
			...
			var post = `
				...
				<div class="card">
					<div class="card-body">
						...
						<button class="btn btn-success button-more"> Leer más </button>
					</div>
				</div>
				</article>
			`;
	...
	if(window.location.href.indexOf('pagina2') > -1){
		$("#acordeon").accordion();
	}


	// Reloj
	if(window.location.href.indexOf('pagina1') > -1){
	...
	// Validación
	if(window.location.href.indexOf('pagina3') > -1){
